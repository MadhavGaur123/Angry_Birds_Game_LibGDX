...
public class Win implements Screen {
    ...
    private Texture backgroundTexture, dialogTexture, ExitTexture, RestartTexture, LevelsTexture,NextTexture ;
    private Sprite dialogSprite, ExitSprite, RestartSprite, LevelsSprite,NextSprite;
    private SpriteBatch spriteBatch;
    private transient Sound winSound;
    ...
    public Win(Main game) {
        ...
        NextSprite = new Sprite(NextTexture);
        NextSprite.setSize(buttonWidth, buttonHeight*3/2);
        NextSprite.setPosition(viewport.getWorldWidth() * 0.4f, buttonY-100);
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            else if (NextSprite.getBoundingRectangle().contains(touchPos.x, touchPos.y)) {
                System.out.println("Exit button touched! Returning to HomeScreen...");
                buttonClickSound.play();
