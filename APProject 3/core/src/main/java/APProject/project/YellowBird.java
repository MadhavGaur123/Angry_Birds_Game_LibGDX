...
public class YellowBird extends Bird implements Serializable {
    ...
    public YellowBird(World world, float x, float y, float scaleX, float scaleY) {
        super(x, y, "yellow_bird.png", scaleX, scaleY);
        ...
        birdTexture = new Texture("yellow_bird.png");
    ...
    public void shoot() {
        if (isDragging) {
            ...
            flyingSound.play();
            shotSound.play();
            float force = 9.3f; // Adjust force as needed
